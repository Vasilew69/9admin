const modulename = 'WebServer:nineadminLog';
 ...
 * @param {object} ctx
 */
export default async function nineadminLog(ctx) {
    //Check permissions
    if (!ctx.utils.hasPermission('nineadmin.log.view')) {
    ...
    //Output
    return ctx.utils.render('main/nineadminLog', {headerTitle: '9Admin Log', consoleLog, actionLog});
};
